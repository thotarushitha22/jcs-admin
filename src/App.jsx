  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h1 style={{ color: "#0f172a", marginBottom: "15px", fontSize: "28px" }}>Welcome to JCS Store</h1>
        <p style={{ color: "#64748b", fontSize: "16px", marginBottom: "30px", lineHeight: "1.5" }}>
          Explore products, shop wholesale, or sign in to manage the platform as an administrator or merchant.
        </p>
